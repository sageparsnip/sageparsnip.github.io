		...
		for(var i = 0; i< Object.keys(data.standardCommon).length; i++){
			$("#StandardCommon").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.standardCommon[i].name + " <d>" + data.standardCommon[i].subname + "</d></div>" +
		...
		for(var i = 0; i< Object.keys(data.standardUncommon).length; i++){
			$("#standardUncommon").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.standardUncommon[i].name + " <d>" + data.standardUncommon[i].subname + "</d></div>" +
		...
		for(var i = 0; i< Object.keys(data.StandardSituational).length; i++){
			$("#StandardSituational").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.StandardSituational[i].name + " <d>" + data.StandardSituational[i].subname + "</d></div>" +
		...
		for(var i = 0; i< Object.keys(data.SkillActions).length; i++){
			$("#SkillActions").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.SkillActions[i].name + " <d>" + data.SkillActions[i].subname + "</d></div>" +
		...
		for(var i = 0; i< Object.keys(data.ExplorationGeneral).length; i++){
			$("#ExplorationGeneral").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.ExplorationGeneral[i].name + " <d>" + data.ExplorationGeneral[i].subname + "</d></div>" +
		...
		for(var i = 0; i< Object.keys(data.ExplorationSkill).length; i++){
			$("#ExplorationSkill").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.ExplorationSkill[i].name + " <d>" + data.ExplorationSkill[i].subname + "</d></div>" +
		...
		for(var i = 0; i< Object.keys(data.DowntimeActivities).length; i++){
			$("#DowntimeActivities").html(function(k, oldHTML){
				...
				"<div class='item'>" +
					...
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.DowntimeActivities[i].name + " <d>" + data.DowntimeActivities[i].subname + "</d></div>" +
	...
	$.getJSON("./data/conditions.json", function (data){
		...
		for(var i = 0; i< Object.keys(data.Senses).length; i++){
			$("#Senses").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					"<div class='item-icon'><i class='fa-solid fa-" + data.Senses[i].icon + " fa-xl'></i><br></div>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data.Senses[i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["Health & Dying"]).length; i++){
			$("#HealthDying").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["Health & Dying"][i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["Visibility"]).length; i++){
			$("#Visibility").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["Visibility"][i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["Physical State"]).length; i++){
			$("#PhysicalState").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["Physical State"][i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["Mental State"]).length; i++){
			$("#MentalState").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["Mental State"][i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["Action Economy"]).length; i++){
			$("#ActionEconomy").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["Action Economy"][i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["NPC Regard"]).length; i++){
			$("#NPCRegard").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["NPC Regard"][i].name + "</div>" +
		...
		for(var i = 0; i< Object.keys(data["Misc."]).length; i++){
			$("#Misc").html(function(k, oldHTML){
				...
				return oldHTML + 
				"<div class='item'>" +
					`<div class='item-header' onclick="openItemOverlay(this)">` + data["Misc."][i].name + "</div>" +
